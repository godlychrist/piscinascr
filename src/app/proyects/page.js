            ...
            <main className="max-w-7xl mx-auto px-6 py-20">
                ...
                <header className="text-center mb-16 px-4">
                    <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight">
                        Catálogo de <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Excelencia</span>
                    </h1>
                    ...
                    <div className="flex justify-center mt-8" aria-hidden="true">
                        ...
                        <div className="w-4 h-1 bg-indigo-400 rounded-full mx-2"></div>
                        <div className="w-16 h-1 bg-blue-600 rounded-full"></div>
                    </div>
                </header>
                ...
                {/* Call to Action */}
                <section className="mt-24 text-center bg-indigo-600 rounded-[2.5rem] p-8 md:p-16 text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <a
                            href="/contacto"
                            className="inline-block bg-white text-indigo-600 px-12 py-5 rounded-2xl font-black text-xl hover:bg-gray-100 transition-all shadow-xl hover:shadow-white/20 transform hover:scale-105"
                        >
