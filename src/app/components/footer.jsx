...
export default function Footer() {
    return (
        <footer className="bg-gray-900 border-t border-white/5 pt-20 pb-10 overflow-hidden relative" aria-labelledby="footer-heading">
            ...
            <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl" aria-hidden="true"></div>
                        ...
                        <div className="flex gap-4">
                            {SOCIAL_LINKS.map((social) => (
                                <a
                                    ...
                                    className="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-white hover:bg-indigo-600 hover:border-indigo-500 transition-all focus:ring-2 focus:ring-indigo-500 outline-none group shadow-lg"
                    ...
                    <nav className="lg:col-span-3 space-y-8" aria-label="Enlaces rápidos del footer">
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={link.name}>
                                    <Link href={link.href} className="text-gray-500 hover:text-indigo-400 transition-colors font-medium flex items-center group focus:text-indigo-400 outline-none">
                                        <span className="w-1.5 h-1.5 bg-indigo-600 rounded-full mr-3 opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity" aria-hidden="true"></span>
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <nav className="lg:col-span-4 space-y-8" aria-label="Información de contacto">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 bg-indigo-600/10 rounded-xl flex items-center justify-center text-indigo-500 shrink-0" aria-hidden="true">
                                ...
                                <div>
                                    ...
                                    <a href={`tel:${CONTACT_INFO.phone}`} className="text-white font-bold text-lg hover:text-indigo-400 transition-colors focus:text-indigo-400 outline-none">{CONTACT_INFO.phone}</a>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 bg-indigo-600/10 rounded-xl flex items-center justify-center text-indigo-500 shrink-0" aria-hidden="true">
                                ...
                                <div>
                                    ...
                                    <a href={`mailto:${CONTACT_INFO.email}`} className="text-white font-bold text-lg hover:text-indigo-400 transition-colors break-all focus:text-indigo-400 outline-none">{CONTACT_INFO.email}</a>
                                </div>
                            </div>
                        </div>
                    </nav>
